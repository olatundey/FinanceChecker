...
//        //            // Parse the response and extract the balance value
//        //            if (decimal.TryParse(content, out decimal balance))
//        //            {
//        //                Console.WriteLine("API call successful. Balance retrieved: {0}", balance);
//        //                _logger.LogInformation("API call successful. Balance retrieved: {Balance}", balance);
//        //                return balance;
//        //            }
//        //        }
//        //        else
...
//        //    }
//        //    // Return 0 or any default value if retrieval fails
//        //    return 0;
//        //}
...
//        //        Console.WriteLine("Error occurred while retrieving transactions from API: {0}", ex.Message);
//        //    }
...
//        {
//            // Now you can use the 'accountNumber' parameter as needed in the action
//            // For example, you can pass it to the view model or display it as a readonly field in the view.
//            // Note that this method does not use TempData and directly passes the account number as a query parameter.
...
//        //    // Find the account with the given account number and belonging to the current user
...
//        //    //try
//        //    //{
//        //    //    // Asynchronously retrieve the account balance from the API
//        //    //    decimal accountBalance = await GetAccountBalanceFromAPI(accountNumber);

//        //    //    // Call the API integration methods to get transactions
//        //    //    List<Transaction> transactions = await GetTransactionsFromAPI(accountNumber);

//        //    //    // Update the Account table with the retrieved balance for the specific account
...
//                // Initialize the BalanceForDay dictionary for each account
...
//                //DateTime dateIterator = sevenDaysAgo;
//                //while (dateIterator <= currentDate)
//                //{
//                //    foreach (var account in accounts)
//                //    {
//                //        // Replace this line with your actual balance calculation logic for each day
//                //        // For now, let's assume the balance is the same for each day
//                //        account.BalanceForDay[dateIterator.Date] = account.Balance;
//                //    }

//                //    decimal totalBalanceForDay = accounts.Sum(a => a.BalanceForDay.ContainsKey(dateIterator.Date) ? a.BalanceForDay[dateIterator.Date] : 0);
//                //    dailyBalances.Add((dateIterator, totalBalanceForDay));
